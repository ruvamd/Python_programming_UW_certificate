...
Welcome to ``ass5_project`` contributor's guide.
...
If you experience bugs or general issues with ``ass5_project``, please have a look
...
You can help improve ``ass5_project`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ass5_project`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ass5_project``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ass5_project python=3 six virtualenv pytest pytest-cov
    conda activate ass5_project
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ass5_project.git
    cd ass5_project
...
#. Install |pre-commit|_::
   ...
   ``ass5_project`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ass5_project
.. _issue tracker: https://github.com/<USERNAME>/ass5_project/issues
.. <-- end -->
